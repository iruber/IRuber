...
public class ItemPedidoDAO {
    ...
    public long inserirItemPedido(ItemPedido itemPedido) {
       ...
       long idPrato=itemPedido.getIdItemPedido();
    ...
    private ItemPedido criarItemPedido(Cursor cursor)throws Exception {
       ...
       int quantidade = cursor.getInt(colunaIndexQuantidade);
        ...
        itemPedido.setIdPrato(idPrato);
        itemPedido.setIdItemPedido(id);
        return itemPedido;
    }


    private ItemPedido criar(String query, String[] args) throws Exception {
    ...
    public ItemPedido getItemPedidoPorId(long id)throws Exception {
    ...
    public ItemPedido getPedidoPorIdPrato(long idPrato)throws Exception {
        String query = SELECT_FROM_ITEM_PEDIDO +
                "WHERE idPrato = ?";
    ...
    public ItemPedido SELECT_FROM_ITEM_PEDIDO(long idPedido)throws Exception {
        String query = SELECT_FROM_ITEM_PEDIDO +
                "WHERE idPedido = ?";
    ...
    public void updateItemPedido(ItemPedido itemPedido) {
        ...
        values.put(ContratoItemPedido.ITEM_PEDIDO_ID_PRATO,itemPedido.getIdPrato());

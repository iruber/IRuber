...
public class ContratoUsuario {
    ...
    public static final String SQL_CREATE_TABLE_USER = "CREATE TABLE "+NOME_TABELA+"(" +
            USUARIO_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT," +
            USUARIO_SENHA+" TEXT NOT NULL, " +
            USUARIO_EMAIL+" TEXT NOT NULL," +
            USUARIO_TIPO+" TEXT ); ";

    public static final String SQL_DELETE_USERS = "DROP TABLE IF EXISTS " + ContratoUsuario.NOME_TABELA;
}
